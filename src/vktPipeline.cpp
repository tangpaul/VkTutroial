...
namespace vkt{
    ...
    vktPipeline::vktPipeline(vktEngineDevice &device,
    ...
    vktPipeline::~vktPipeline(){
        vkDestroyShaderModule(m_device.device(), m_vertShaderModule, nullptr);
        vkDestroyShaderModule(m_device.device(), m_fragShaderModule, nullptr);
        vkDestroyPipeline(m_device.device(), m_graphicsPipeline, nullptr);
    }

    std::vector<char> vktPipeline::readFile(const std::string &filePath)
    {
    ...
    void vktPipeline::createGraphicsPipeline(
        const std::string &vertShaderPath,
        const std::string &fragShaderPath,
        const PipelineConfigInfo &configInfo){
        //
        ...
        //
        auto attributeDescriptions = vktModel::Vertex::getAttributeDescriptions();
        auto bindingDescriptions = vktModel::Vertex::getBindingDescriptions();
    ...
    void vktPipeline::createShaderModule(
        ...
        // The bytecode is uint32_t*, but the data is char*, so we need to cast it
    ...
    void vktPipeline::bind(VkCommandBuffer commandBuffer)
    {
